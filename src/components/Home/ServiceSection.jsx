...
const services = [
  {
    ...
    desc: "Preserve your vehicle's showroom finish with our ultra-durable Paint Protection Film. Our high-grade clear bras protect against stone chips, scratches, and road debris with self-healing technology.",
    image: "/ppf.avif",
    path: "/services/ppf",
  },
  {
    title: "DETAILING & VALETING",
    desc: "A comprehensive unit-based service providing deep cleaning and paint correction. From interior restoration to exterior ceramic coatings, we ensure your vehicle looks its absolute best.",
    image: "/detailing.avif",
    path: "/services/detailing-valeting",
  },
  
  {
    title: "DIAGNOSTICS",
    desc: "Advanced dealer-level diagnostics to identify faults and optimize performance. We offer local collection and delivery for your convenience, ensuring a hassle-free experience.",
    image: "/diagnostics.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto ">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-35   "
                    onError={(e) => {
