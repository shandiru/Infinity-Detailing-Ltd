...
const testimonials = [
{
    text: "Top-tier diagnostics and chip tuning. They found a recurring fault that three other garages missed and fixed it alongside a performance map. Truly expert level knowledge and great customer service.",
    name: "Sarah Williams"
  }
